...
def train_sample(sample, raft_model, raft_optimizer, raft_scheduler, raft_scaler, isTrain=True):
    ...
    real_lcn_reproj_loss, real_lcn_warped, real_lcn_reproj_mask = get_reproj_error_patch(
    ...
    img_output_reproj = {
        'sim_reprojection': {
            'target': img_L_lcn, 'warped': sim_lcn_warped, 'pred_disp': sim_pred_disp, 'mask': sim_lcn_reproj_mask
        },
        'real_reprojection': {
            'target': img_real_L_lcn, 'warped': real_lcn_warped, 'pred_disp': real_pred_disp, 'mask': real_lcn_reproj_mask
        }
    }
