...
class MessytableTestDataset(Dataset):
    def __init__(self, split_file, debug=False, sub=100, onReal=False):
        ...
        # TODO
        meta_file_path0 = '/cephfs/datasets/iccv_pnp/messy-table-dataset/v9/training/0-0-0/meta.pkl'
        meta_file_path = '/cephfs/datasets/iccv_pnp/messy-table-dataset/real_v9/training/0-300002-1/meta.pkl'
        self.img_meta0 = load_pickle(meta_file_path0)
        self.img_meta = load_pickle(meta_file_path)
    ...
    def __getitem__(self, idx):
        ...
        img_meta = self.img_meta0 if prefix[-2:] == '-0' else self.img_meta
