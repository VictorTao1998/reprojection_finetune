...
# python -m torch.distributed.launch RAFT/train_raft.py --summary-freq 1 --save-freq 1 --logdir ../train_10_14_psmnet_ir_reprojection/debug --debug
# python -m torch.distributed.launch RAFT/train_raft.py --config-file ./RAFT/raft_config.yaml --summary-freq 10 --save-freq 100 --logdir /isabella-slow/RAFT/train_1_26_ir_reproj/debug --debug --mixed_precision
...
def train(raft_model, raft_optimizer, raft_scheduler, raft_scaler, TrainImgLoader, ValImgLoader):
    for epoch_idx in range(cfg.SOLVER.EPOCHS):
        ...
        for batch_idx, sample in enumerate(TrainImgLoader):
            ...
            # Train one sample
            scalar_outputs_raft, img_outputs_raft = \
...
def train_sample(sample, raft_model, raft_optimizer, raft_scheduler, raft_scaler, isTrain=True):
    ...
    return scalar_outputs_raft, img_outputs_raft
