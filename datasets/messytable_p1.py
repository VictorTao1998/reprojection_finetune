...
class MessytableDataset(Dataset):
    def __init__(self, split_file, gaussian_blur=False, color_jitter=False, debug=False, sub=100):
        ...
        self.img_real_L_no_ir, self.img_real_R_no_ir = __get_split_files__(split_file, debug, sub)
    ...
    def __getitem__(self, idx):
        ...
        img_real_L_ir_pattern = __get_ir_pattern__(img_real_L, img_real_L_no_ir)  # [H, W]
        img_real_R_ir_pattern = __get_ir_pattern__(img_real_R, img_real_R_no_ir)  # [H, W]
