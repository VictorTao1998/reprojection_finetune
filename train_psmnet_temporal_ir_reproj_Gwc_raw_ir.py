...
from nets.stackhourglass import LACGWCNet
...
if __name__ == '__main__':
    ...
    # Create PSMNet model
    #psmnet_model = LACGWCNet(maxdisp=cfg.ARGS.MAX_DISP).to(cuda_device)
    affinity_settings = {}
    ...
    psmnet_model = LACGWCNet(maxdisp=cfg.ARGS.MAX_DISP, struct_fea_c=args.lsp_channel, fuse_mode=args.lsp_mode,
               affinity_settings=affinity_settings, udc=udc, refine=args.refine).to(cuda_device)
