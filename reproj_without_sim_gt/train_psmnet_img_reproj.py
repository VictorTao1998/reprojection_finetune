...
# python -m torch.distributed.launch reproj_without_sim_gt/train_psmnet_img_reproj.py --summary-freq 1 --save-freq 1 --logdir ../train_10_14_psmnet_reprojection/debug --debug
# python -m torch.distributed.launch reproj_without_sim_gt/train_psmnet_img_reproj.py --config-file configs/remote_train_steps.yaml --summary-freq 10 --save-freq 100 --logdir ../train_10_14_psmnet_reprojection/debug --debug
# python -m torch.distributed.launch reproj_without_sim_gt/train_psmnet_img_reproj.py --config-file configs/remote_train_primitive_randscenes.yaml --summary-freq 10 --save-freq 100 --logdir ../train_10_14_psmnet_reprojection/debug --debug
...
def train_sample(sample, transformer_model, psmnet_model,
    ...
    img_real_L = sample['img_real_L'].to(cuda_device)  # [bs, 3, H, W]
    img_real_R = sample['img_real_R'].to(cuda_device)  # [bs, 3, H, W]
