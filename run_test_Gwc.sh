...
--model '/jianyu-fast-vol/eval/reprojection_gwc/train_reprojection_gwc_rawir/models/model_40000.pth' \
--output '/jianyu-fast-vol/eval/reprojection_gwc/test_reprojection_Gwc_rawir/' \
--onreal \
--exclude-bg 