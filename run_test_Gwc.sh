...
--model '/jianyu-fast-vol/eval/reprojection_finetune/train_reprojection_Gwc_sim/models/model_40000.pth' \
--output '/jianyu-fast-vol/eval/reprojection_finetune/test_reprojection_Gwc_sim/' \
--onreal \
--exclude-bg 